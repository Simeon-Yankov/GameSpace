...
namespace GameSpace.Data.Migrations
{
    ...
    [Migration("20210822183223_APITable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameSpace.Data.Models.API", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("GameSpace.Data.Models.UserTeamsTournamentTeam", b =>
                {
                    b.Property<int>("TeamsTournamentTeamId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("TeamsTournamentTeamId", "UserId");

                    b.HasIndex("UserId");

                    b.ToTable("UsersTeamsTournamentTeams");
                });
            ...
            modelBuilder.Entity("GameSpace.Data.Models.UserTeamsTournamentTeam", b =>
                {
                    b.HasOne("GameSpace.Data.Models.TeamsTournamentTeam", "TeamsTournamentTeam")
                        .WithMany("InvitedMembers")
                        .HasForeignKey("TeamsTournamentTeamId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GameSpace.Data.Models.User", "User")
                        .WithMany("InvitedToTournament")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("TeamsTournamentTeam");
            ...
            modelBuilder.Entity("GameSpace.Data.Models.User", b =>
                {
                    ...
                    b.Navigation("InvitedToTournament");
